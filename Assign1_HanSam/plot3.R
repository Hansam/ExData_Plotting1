...
plot(consume_sub$Sub_metering_1~consume_sub$Date_Time,type="n", 
     xlab="",ylab=c("Energy sub metering"))
lines(consume_sub$Sub_metering_1~consume_sub$Date_Time,col="black")
lines(consume_sub$Sub_metering_2~consume_sub$Date_Time,col="red")
lines(consume_sub$Sub_metering_3~consume_sub$Date_Time, col="blue")
